...
<div class="container">
    <h2>Misión</h2>
    <p>Nuestra misión es ser la plataforma de alimentos más inteligente y útil que existe.</p>

    <p>Completamos esta tarea sumando vida en la cocina
        Para millones de casos de cosineros en todo el mundo.</p>

    <h3>Ayudamos a las personas a saber qué comer en función de sus preferencias e información personal</h3>

    <img src="/recetario/assets/img/mission.png" alt="mission_img">
